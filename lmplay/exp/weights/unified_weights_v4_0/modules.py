...
class DULinear(nn.Module):
  ...
  def __init__(self,
    ...
    self.mbias_weights_1 = nn.Linear(self.expansion_features, self.bias_weights_hidden)
    self.mbias_weights_2 = nn.Linear(self.bias_weights_hidden, out_features)
  ...
  def forward(self, input: torch.Tensor) -> torch.Tensor:
    ...
    mbias = F.gelu(self.mbias_weights_1(self.expansion_data))
