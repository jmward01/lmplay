...
class GPT2(LMBase):
  def __init__(self,
    ...
    self.shared_mid_weights = nn.Linear(embed_dim*8, embed_dim)
    #This version is 2.5 but using a different SULinear for the final fc
    ...
    #not really shared here. Just doing this to test a theory
    self.shared_mid_weights2 = nn.Linear(embed_dim*8, embed_dim)
    shared_mid_linear2 = partial(SULinear, self.shared_mid_weights)
    self.fc = shared_mid_linear2(embed_dim, vocab_size)
