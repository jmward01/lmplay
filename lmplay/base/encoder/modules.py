...
class MultiheadAttention(nn.Module):
  """This class is a re-implementation of the pytorch version. It is here mainly to 'open up' MHA and let it be played with by future experiments.
  Is it as good? NO! Is it a perfect reference implementation? Definitely not! But it makes it easy to swap in/out ideas which is the point of this repo.
  This code is a mish-mash of code from all over the internet. I'm not really sure who to credit the roots of it with.
  """
  def __init__(self,
               max_len: int,
               num_heads: int,
